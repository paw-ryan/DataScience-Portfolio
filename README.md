...
- [Survey of Labor and Income Dynamics (SLID)]: A regression model was created to understand the wage dynamics in Canada. ANOVA was used to describe the overall performance. 
...
- Breast Cancer Wisconsin Study: An exploratory data analysis to predict a fine needle aspirate (FNA) of a breast mass using a linear model. 
